...
function loadConfiguration() {
    ...
    databaseOptions.host = process.env.SWC_DB_HOST || process.env.DATABASE_HOST || databaseOptions.host;
    databaseOptions.port = process.env.SWC_DB_PORT || databaseOptions.port;
