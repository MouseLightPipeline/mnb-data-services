...
function loadConfiguration() {
    ...
    databaseOptions.sample.port = process.env.SAMPLE_DB_PORT || process.env.DATABASE_PORT || databaseOptions.sample.port;
    ...
    databaseOptions.swc.port = process.env.SWC_DB_PORT || process.env.DATABASE_PORT || databaseOptions.swc.port;
    ...
    databaseOptions.transform.port = process.env.TRANSFORM_DB_PORT || process.env.DATABASE_PORT || databaseOptions.transform.port;
    ...
    databaseOptions.search.port = process.env.SEARCH_DB_PORT || process.env.DATABASE_PORT || databaseOptions.search.port;
